...
\author[Arda Çekiç]{Arda Çekiç\\\href{mailto:acekic@aselsan.com.tr}{acekic@aselsan.com.tr}}
%\author[J.\,Doe \& J.\,Doe]
%{%
%  \texorpdfstring{
...
\title[WINS Beamer Template]{Ceng532 Term Project Presentation}
\subtitle[Short SubTitle]{Frederickson's Distributed BFS Algorithm}
%\date{} 
...
%\end{frame}
%
\section{The Distributed Network BFS Trees}
%\begin{frame}
%        \sectionpage
%\end{frame}
